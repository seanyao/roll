...
| [US-AUTO-002](docs/features/autonomous-evolution.md#us-auto-002) | roll-dream — 每晚代码/架构健康巡检，产出 REFACTOR 条目 | 📋 Todo |
| [US-AUTO-003](docs/features/autonomous-evolution.md#us-auto-003) | roll-brief — Feature完成/每日晨报/按需简报，含发布就绪建议 | 📋 Todo |
| [US-AUTO-004](docs/features/autonomous-evolution.md#us-auto-004) | roll-loop — BACKLOG 自主执行器 + 调度器 + 跨Agent路由 + 失败处理 | 📋 Todo |
