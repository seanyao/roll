...
| [US-AUTO-033](docs/features/autonomous-evolution.md#us-auto-033) | loop 自动建 PR + GitHub Auto-merge — story 完成后推 `loop/<US>` 分支，自动 `gh pr create` + `gh pr merge --auto --squash`，CI 绿自动合并，人零介入 `depends-on:US-AUTO-037` | 🔨 In Progress |
