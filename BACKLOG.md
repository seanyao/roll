...
| REFACTOR-004 | 修复 `_write_backlog()` + `_ensure_features_dir()` 使用 `_WK_MERGE_SUMMARY` 而非 `_ROLL_MERGE_SUMMARY`，导致 roll init 摘要中静默丢失 BACKLOG/docs/features 条目 — flagged by dream 2026-05-11 | 🔨 In Progress |
