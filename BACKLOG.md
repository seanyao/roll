...
| Story | Description | Status |
|-------|-------------|--------|
| [US-PR-001](docs/features/pr-lifecycle.md#us-pr-001) | PR 评审不再绑定特定 AI 或 git 平台 — 任何 agent、任何 git 平台均可用 `roll review-pr` 触发评审 `peer-review:kimi,pi,gemini` | 🔨 In Progress |
