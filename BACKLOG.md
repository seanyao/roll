...
| [US-CL-004](docs/features/changelog-integration.md#us-cl-004) | changelog 风格守门 Phase 1 — 机械 linter（黑名单 grep）+ 把最近 3 个已发布版本的 bullets 作为 in-context few-shot 锚点；4a12ccf 实证过的 10 条技术黑话草稿应全部被挡回重写 | 📋 Todo |
