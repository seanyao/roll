...
**AC:**
- [ ] Phase 5.5 section added between Phase 5 (TCR Loop) and Phase 6 (Pre-Push CI Gate)
- [ ] Phase detects project's existing E2E infrastructure (directories, config, framework, naming)
- [ ] When E2E infrastructure exists: writes one test following project conventions, runs green, commits as TCR micro-step
- [ ] When no E2E infrastructure exists: references roll-.qa "Missing Test Infrastructure" section for bootstrap path
- [ ] Definition of Done updated to include "E2E deposited"
- [ ] Required Artifacts updated to include E2E test file
