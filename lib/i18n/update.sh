...
_i18n_set en update.upgrading_via_curl "Upgrading via curl..."
_i18n_set zh update.upgrading_via_curl "正在通过 curl 升级..."
_i18n_set en update.npm_install_failed_check_network_proxy "npm install failed. Check network/proxy and try again."
_i18n_set zh update.npm_install_failed_check_network_proxy "安装失败，请检查网络/代理后重试。"
_i18n_set en update.curl_download_failed "Download failed. Check network/proxy and try again."
_i18n_set zh update.curl_download_failed "下载失败，请检查网络/代理后重试。"
_i18n_set en update.curl_extract_failed "Extraction failed. The downloaded archive may be corrupted."
_i18n_set zh update.curl_extract_failed "解压失败，下载的归档可能已损坏。"
_i18n_set en update.new_version "Upgraded to roll v%s"
_i18n_set zh update.new_version "已升级到 roll v%s"
