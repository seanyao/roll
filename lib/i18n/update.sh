...
_i18n_set en update.curl_install_failed "curl install failed. Check network connection and try again."
_i18n_set zh update.curl_install_failed "curl 安装失败，请检查网络连接后重试。"
