...
export const v3Catalog: Catalog = {
  ...
  "workspace.create.error.invalid_arguments": { en: "Usage: roll workspace create <id> --config <file> [--check] [--json]", zh: "用法：roll workspace create <ID> --config <文件> [--check] [--json]" },
